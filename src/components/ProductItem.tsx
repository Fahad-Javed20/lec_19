  ...
  return (
    <div className="bg-white shadow-md w-1/4 rounded-md flex flex-col gap-4">
      <div className="relative">
        <img className="rounded-md h-72 w-full object-cover" src={image} alt="" />
      ...
      <p className="text-left font-bold pl-4">Price:{price} </p>
      <button
        onClick={onIncrement}
        className="bg-amber-900 w-full rounded-2xl mt-6 mb-4 py-1 text-white px"
      >
        ADD TO CART
      </button>
    </div>
